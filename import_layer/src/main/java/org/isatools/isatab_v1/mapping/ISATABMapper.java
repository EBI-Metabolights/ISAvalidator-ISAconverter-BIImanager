...
import org.isatools.isatab.mapping.StudyFormatTabMapper;
import org.isatools.isatab.mapping.gel_electrophoresis.GelFormatTabMapper;
import org.isatools.isatab.mapping.generic_assay.GenericAssayFormatTabMapper;
import org.isatools.isatab.mapping.msSpec.MsFormatTabMapper;
import org.isatools.isatab.mapping.nmrSpec.NmrFormatTabMapper;
import org.isatools.isatab_v1.mapping.microarray.MaFormatTabMapper;
import org.isatools.tablib.schema.FormatSetInstance;
import org.isatools.tablib.utils.BIIObjectStore;

/**
 * The ISATAB mapper for v1 and above.
 * <p/>
 * <dl><dt>date:</dt><dd>Oct 22, 2008</dd></dl>
 *
 * @author brandizi
 */
public class ISATABMapper extends org.isatools.isatab.mapping.ISATABMapper {

    public ISATABMapper(BIIObjectStore store, FormatSetInstance formatSetInstance) {
        super(store, formatSetInstance);
        this.formatMappersConfig.clear();
        ...
        this.formatMappersConfig.put("generic_assay", GenericAssayFormatTabMapper.class);
