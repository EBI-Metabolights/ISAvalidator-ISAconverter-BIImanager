...
public class MetabolightsPersistenceTest extends TransactionalDBUnitEJB3DAOTest {

	public MetabolightsPersistenceTest() throws Exception {
		super();
	}
	...
	public void testPersistence() throws Exception {
		...
		out.println("\n\n_______________________ Metabolights Persistence Test _______________________\n\n");

		String baseDir = System.getProperty("basedir");
		if (baseDir == null) baseDir =".";
		String filesPath = baseDir + "/target/test-classes/test-data/isatab/isatab_v1_200810/metabolights_201203";
...
//		assertTrue("Ops! I didn't find any assay annotation about their linked data files!", hasSomeAnn);
		...
		out.println("\n\n___________________ /end: Metabolights Persistence Test ___________________\n\n");
	}
